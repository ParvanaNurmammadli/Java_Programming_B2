...
public class T000_xpath_getText {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        if(actualUrlForResetPassword.contains(DocuportConstants.ACTUAL_URL_RESET_PASSWORD)){
            System.out.println("TEST PASS: => Actual url: " + actualUrlForResetPassword + " contains expected url: " + DocuportConstants.ACTUAL_URL_RESET_PASSWORD);
        } else {
            System.out.println("TEST FAIL: => Actual url: " + actualUrlForResetPassword + " does not contain expected url: " + DocuportConstants.ACTUAL_URL_RESET_PASSWORD);
        }
        ...
        if(actualValidateMessage.contains(DocuportConstants.ERROR_MESSAGE_FOR_PASSWORD)){
            System.out.println("TEST PASS: => Actual validate message: \""+actualValidateMessage+"\" contains expected message \""+DocuportConstants.ERROR_MESSAGE_FOR_PASSWORD);
        }else {
            System.out.println("TEST FAIL: => Actual validate message: \""+actualValidateMessage+"\" doesnt contains expected message \""+DocuportConstants.ERROR_MESSAGE_FOR_PASSWORD);
